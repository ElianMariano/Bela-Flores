...
function CreateProduct(){
    ...
    async function handleSubmit(e: React.FormEvent){
        ...
        await api.post('product', data, config).then(res => {
    ...
    return (
        <>
            ...
            <form className="productform-container" onSubmit={handleSubmit}>
                <h3 className="create-product-title">Criar Produto</h3>
                ...
                <Button type="submit" width='20%' height='6vh' fontSize='18px'>Criar Produto</Button>
            </form>
        </>
    )
}
